...
<div class="footer-top">
    <div class="container-fluid">
        ...
        <div class="col-xs-4 w3l-rightmk">
            <img src="{{ asset('/') }}fron/images/tab3.png" alt=" ">
        </div>
        ...
        <div class="footer-info w3-agileits-info">
            ...
            <div class="col-sm-2 footer-grids  w3l-socialmk">
                ...
                <div class="agileits_app-devices">
                    ...
                    <a href="#">
                        <img src="{{ asset('/') }}fron/images/1.png" alt="">
                    </a>
                    <a href="#">
                        <img src="{{ asset('/') }}fron/images/2.png" alt="">
                    </a>
                    <div class="clearfix"> </div>
                </div>
            </div>
        ...
        <div class="agile-sometext">
            <div class="sub-some">
                ...
                <p>Order online. All your favourite products from the low price online supermarket for grocery home delivery in Delhi,
                    ...
                    Saffola, Huggies, Fortune, Nestle, Amul, MamyPoko Pants, Surf Excel, Ariel, Vim, Haldirams and others.</p>
            </div>
            <div class="sub-some">
            ...
            <div class="sub-some child-momu">
                ...
                <ul>
                    <li>
                        <img src="{{ asset('/') }}fron/images/pay2.png" alt="">
                    </li>
                    <li>
                        <img src="{{ asset('/') }}fron/images/pay5.png" alt="">
                    </li>
                    <li>
                        <img src="{{ asset('/') }}fron/images/pay1.png" alt="">
                    </li>
                    <li>
                        <img src="{{ asset('/') }}fron/images/pay4.png" alt="">
                    </li>
                    <li>
                        <img src="{{ asset('/') }}fron/images/pay6.png" alt="">
                    </li>
                    <li>
                        <img src="{{ asset('/') }}fron/images/pay3.png" alt="">
                    </li>
                    <li>
                        <img src="{{ asset('/') }}fron/images/pay7.png" alt="">
                    </li>
                    <li>
                        <img src="{{ asset('/') }}fron/images/pay8.png" alt="">
                    </li>
                    <li>
                        <img src="{{ asset('/') }}fron/images/pay9.png" alt="">
                    </li>
                </ul>
            </div>
            <!-- //payment -->
...
<!-- js-files -->
<!-- jquery -->
<script src="{{ asset('/') }}fron/js/jquery-2.1.4.min.js"></script>
<!-- //jquery -->

<!-- popup modal (for signin & signup)-->
<script src="{{ asset('/') }}fron/js/jquery.magnific-popup.js"></script>
<script>
...
<!-- cart-js -->
<script src="{{ asset('/') }}fron/js/minicart.js"></script>
<script>
...
<script src="{{ asset('/') }}fron/js/jquery-ui.js"></script>
<script>
    //<![CDATA[ 
...
<script src="{{ asset('/') }}fron/js/jquery.flexisel.js"></script>
<script>
    $(window).load(function () {
...
<!-- smoothscroll -->
<script src="{{ asset('/') }}fron/js/SmoothScroll.min.js"></script>
<!-- //smoothscroll -->

<!-- start-smooth-scrolling -->
<script src="{{ asset('/') }}fron/js/move-top.js"></script>
<script src="{{ asset('/') }}fron/js/easing.js"></script>
<script>
...
<script src="{{ asset('/') }}fron/js/habiiib.js"></script>

<!-- imagezoom -->
<script src="{{ asset('/') }}fron/js/imagezoom.js"></script>
<!-- //imagezoom -->

<!-- FlexSlider -->
	<script src="{{ asset('/') }}fron/js/jquery.flexslider.js"></script>
	<script>
    ...
    <script>
        ...
        $('#emailAddress').blur(function () {
            var email = $(this).val();
            $.ajax({
                url: 'http://localhost/ecommerce2/public/customer-email-check/'+email,
                method: 'GET',
                dataType: 'JSON',
                success: function (email) {
                       $('#res').html(email);
                       if (email == 'Email Address already exists') {
    ...
    {{-- <script src="{{ asset('/') }}fron/js/owl.carousel.min.js"></script> --}}
...
<Script>
    ...
    @php $pros=DB::table('products')->take(10)->get(); @endphp
