            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-play-circle-o" ></i>  Slider</a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ route('slider.index') }}">Manage</a>
                                </li>
                                <li>
                        ...
                        <li>
                            <a href="{{ route('manage-order') }}"><i class="fa fa-sitemap fa-fw"></i> Orders<span class="fa arrow"></span></a>
